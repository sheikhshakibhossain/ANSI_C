...
int expectoPetronum(int num) {
        ...
        int c1 = checkFunc1(num);
        int c2 = checkFun2(num);
        int c3 = checkFun3(num);
        int c4 = checkFun4(num);
